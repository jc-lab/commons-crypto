...
export default class ECPublicKey
{
  ...
  constructor(parameters: any = {})
  {
    ...
    this.algorithmParams = getParametersValue(parameters, 'algorithmParams', ECPublicKey.defaultValues('algorithmParams'));
  ...
  toJSON()
  {
    ...
    return {
      crv: crvName,
      x: (toBase64 as any)(arrayBufferToString(this.x), true, true, false),
      y: (toBase64 as any)(arrayBufferToString(this.y), true, true, false)
    };
  }
  //**********************************************************************************
  /**
