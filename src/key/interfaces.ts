...
export abstract class AsymmetricKeyAlgorithm {
  ...
  public abstract sign(digestOid: asn1js.ObjectIdentifier | string | null, hash: Buffer, privateKey: AsymmetricKeyObject): Buffer;
  public abstract verify(digestOid: asn1js.ObjectIdentifier | string | null, hash: Buffer, signature: Buffer, publicKey: AsymmetricKeyObject): boolean;
...
export abstract class AsymmetricKeyObject extends KeyObject {
  ...
  public sign(digestOid: asn1js.ObjectIdentifier | string | null, hash: Buffer): Buffer {
