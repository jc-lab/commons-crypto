...
export function rsaSign (priv: BNRSAPrivateKey, payload: Buffer) {
...
export function rsaVerify (pub: BNRSAPublicKey, sig: Buffer, payload: Buffer): boolean {
  ...
  sigT1 = sigT1.redPow(pub.publicExponent);
